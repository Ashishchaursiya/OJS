...
class DiscountForYou extends Component {
    ...
    openTabSection = (evt, tabNmae) => {
        ...
        tabcontent = document.getElementsByClassName("tabs_item_special4");
                    ...
                    <div className="tab products-category-tab-style-2">
                        <div className="row">
                            <div className="col-lg-12 col-md-12">
                                <div className="title">
                                    <h2><span className="dot"></span>DiscountForYou</h2>
                                </div>

                                <ul className="tabs">
                                    <li
                                          onClick={(e) => { this.openTabSection(e, 'tab4'); this.setState({ 
                                            item: 4
                                        })}}
                                        className="current"
                                    >
                            ...
                            <div className="col-lg-12 col-md-12">
                                <div className="tab_content">
                                    <div id="tab4" className="tabs_item_special4">
                                        <div className="row">
                                                ...
                                                <div className="col-lg-3 col-sm-6 col-6" key={idx}>
                                                    <div className="single-product-box">
                                                        ...
                                                        <div className="product-content">
                                                           ...
                                                           {
                                                            data.discountType!=2 &&  <div class="bg-primary text-white py-2 my-1 text-bold"><b>Discount: {data.discountType==0 ?'$'+ data.discount :data.discount +'%'} OFF</b> </div>
                                                           }
