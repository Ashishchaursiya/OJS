...
class TopRated extends Component {
    ...
    openTabSection = (evt, tabNmae) => {
        ...
        tabcontent = document.getElementsByClassName("tabs_item_special2");
                    ...
                    <div className="tab products-category-tab-style-2">
                        <div className="row">
                            <div className="col-lg-12 col-md-12">
                                <div className="title">
                                    <h2><span className="dot"></span> TopRated</h2>
                                </div>

                                <ul className="tabs">
                                    <li
                                          onClick={(e) => { this.openTabSection(e, 'tab2'); this.setState({ 
                                            item: 4
                                        })}}
                                        className="current"
                                    >
                            ...
                            <div className="col-lg-12 col-md-12">
                                <div className="tab_content">
                                    <div id="tab2" className="tabs_item_special2">
                                        <div className="row">
                                                ...
                                                <div className="col-lg-3 col-sm-6 col-6" key={idx}>
                                                    <div className="single-product-box">
                                                        ...
                                                        <div className="product-content">
                                                            <h3>
                                                                <Link href="/product/[id]" as={`/product/${data._id}`}>
                                                                    <a>{data.productName.length>22 ? data.productName.slice(0,22)+'...' :data.productName}</a>
                                                                </Link>
                                                            </h3>
