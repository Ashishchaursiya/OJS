...
class FlashSaleProduct extends Component {
    ...
    openTabSection = (evt, tabNmae) => {
        ...
        tabcontent = document.getElementsByClassName("tabs_item_special6");
                    ...
                    <div className="tab products-category-tab-style-2">
                        <div className="row">
                            <div className="col-lg-12 col-md-12">
                                <div className="title">
                                    <h2><span className="dot"></span> FlashSaleProducts</h2>
                                </div>

                                <ul className="tabs">
                                    <li
                                          onClick={(e) => {e.preventDefault(); this.openTabSection(e, 'tab6'); this.setState({ 
                                            item: 4
                                        })}}
                                        className="current"
                                    >
                            ...
                            <div className="col-lg-12 col-md-12">
                                <div className="tab_content">
                                    <div id="tab6" className="tabs_item_special6">
                                        <div className="row">
