...
class YouMayLike extends Component {
    ...
    openTabSection = (evt, tabNmae) => {
        ...
        tabcontent = document.getElementsByClassName("tabs_item_special5");
                    ...
                    <div className="tab products-category-tab-style-2">
                        <div className="row">
                            <div className="col-lg-12 col-md-12">
                                <div className="title">
                                    <h2><span className="dot"></span> YouMayLike </h2>
                                </div>

                                <ul className="tabs">
                                    <li
                                          onClick={(e) => { this.openTabSection(e, 'tab5'); this.setState({ 
                                            item: 4
                                        })}}
                                        className="current"
                                    >
                            ...
                            <div className="col-lg-12 col-md-12">
                                <div className="tab_content">
                                    <div id="tab5" className="tabs_item_special5">
                                        <div className="row">
